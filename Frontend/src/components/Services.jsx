...
const Services = () => {
  return (
   <>
   <div id='services' className='mt-8 pt-10'>
...
<br />
   ...
   <div class="-mx-4 flex flex-wrap mt-8 p-8">
    ...
    <div class="w-full px-4 md:w-1/2 lg:w-1/3">
        <div class="mb-9 rounded-xl py-8 px-7 shadow-md transition-all hover:shadow-lg sm:p-9 lg:px-6 xl:px-9">
            ...
            <div>
                <h3 class="mb-4 text-xl font-bold text-black sm:text-2xl lg:text-xl xl:text-2xl">Affordable Deals
                </h3>
                <p class="text-base font-medium text-body-color">"Discover LuxeRide's affordable deals, ensuring luxury car rentals fit within your budget seamlessly.</p>
            </div>
        </div>
    </div>
    ...
    <div class="w-full px-4 md:w-1/2 lg:w-1/3">
        <div class="mb-9 rounded-xl py-8 px-7 shadow-md transition-all hover:shadow-lg sm:p-9 lg:px-6 xl:px-9">
            ...
            <div>
                <h3 class="mb-4 text-xl font-bold text-black sm:text-2xl lg:text-xl xl:text-2xl">Money Back Guarantee
                </h3>
                <p class="text-base font-medium text-body-color">Rest assured with our Money Back Guarantee at LuxeRide. Your satisfaction is our promise, backed by confidence in our exceptional service.</p>
            </div>
        </div>
    </div>
    ...
    <div class="w-full px-4 md:w-1/2 lg:w-1/3">
        <div class="mb-9 rounded-xl py-8 px-7 shadow-md transition-all hover:shadow-lg sm:p-9 lg:px-6 xl:px-9">
            ...
            <div>
                <h3 class="mb-4 text-xl font-bold text-black sm:text-2xl lg:text-xl xl:text-2xl">Nationwide Services
                </h3>
                <p class="text-base font-medium text-body-color">Nationwide Services at LuxeRide: From coast to coast, enjoy seamless luxury car rentals wherever your journey takes you.</p>
            </div>
        </div>
    </div>
    ...
    <div class="w-full px-4 md:w-1/2 lg:w-1/3">
        <div class="mb-9 rounded-xl py-8 px-7 shadow-md transition-all hover:shadow-lg sm:p-9 lg:px-6 xl:px-9">
            ...
            <div>
                <h3 class="mb-4 text-xl font-bold text-black sm:text-2xl lg:text-xl xl:text-2xl">Reasonable Rates</h3>
                <p class="text-base font-medium text-body-color">Experience luxury at reasonable rates with LuxeRide's impeccable car rental services. Enjoy premium vehicles without compromising your budgets.</p>
            </div>
        </div>
    </div>
    ...
    <div class="w-full px-4 md:w-1/2 lg:w-1/3">
        <div class="mb-9 rounded-xl py-8 px-7 shadow-md transition-all hover:shadow-lg sm:p-9 lg:px-6 xl:px-9">
            ...
            <div>
                <h3 class="mb-4 text-xl font-bold text-black sm:text-2xl lg:text-xl xl:text-2xl">Security and Safety First</h3>
                <p class="text-base font-medium text-body-color">"At LuxeRide, security and safety come first. We prioritize your well-being with rigorous measures and protocols in place.</p>
            </div>
        </div>
    </div>
    ...
    <div class="w-full px-4 md:w-1/2 lg:w-1/3">
        <div class="mb-9 rounded-xl py-8 px-7 shadow-md transition-all hover:shadow-lg sm:p-9 lg:px-6 xl:px-9">
            ...
            <div>
                <h3 class="mb-4 text-xl font-bold text-black sm:text-2xl lg:text-xl xl:text-2xl">Registered Vehicles
                </h3>
                <p class="text-base font-medium text-body-color">"At LuxeRide, we offer peace of mind with registered vehicles, ensuring safety, reliability, and compliance with all regulatory standards.</p>
            </div>
        </div>
    </div>
...
<div class="max-w-screen-lg mx-auto px-4 sm:px-6 lg:px-8 flex flex-col justify-between">
    ...
    <div class="mt-20">
        <ul class="md:grid md:grid-cols-3 md:col-gap-10 md:row-gap-10">
            ...
            <li class=" bg-indigo-100 p-5 pb-10 text-center">
                <div class="flex flex-col items-center">
                    ...
                    <div class="mt-4">
                        <h4 class="text-lg leading-6 font-semibold text-gray-900">Select Location</h4>
                        <p class="mt-2 text-base leading-6 text-gray-500">
                        Select your desired location from our wide range of convenient rental locations across the country.
            ...
            <li class=" bg-indigo-100 p-5 pb-10 text-center">
                <div class="flex flex-col items-center">
                    ...
                    <div class="mt-4">
                        <h4 class="text-lg leading-6 font-semibold text-gray-900">Select Date</h4>
                        <p class="mt-2 text-base leading-6 text-gray-500">
                        Choose your pickup and return dates to fit your schedule, ensuring flexibility and convenience.
                        </p>
                    </div>
                </div>
            </li>
            <li class="bg-indigo-100 p-5 pb-10 text-center">
                <div class="flex flex-col items-center">
                    ...
                    <div class="mt-4">
                        <h4 class="text-lg leading-6 font-semibold text-gray-900">Book Your Car</h4>
                        <p class="mt-2 text-base leading-6 text-gray-500">
                        Book your preferred car with ease through our user-friendly online platform, securing your reservation instantly.
                        </p>
                    </div>
                </div>
            </li>
